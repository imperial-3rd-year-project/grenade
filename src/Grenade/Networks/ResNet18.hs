...
type ResNet18BranchRight size channels
  = Network
      '[ PaddedConvolution ('D3 size size channels) ('D3 size size channels) 'WithoutBias channels channels 3 3 1 1 1 1 1 1
...
type ResNet18BranchShrinkRight inSize outSize inChannels outChannels
  = Network
      '[ PaddedConvolution ('D3 inSize inSize inChannels) ('D3 outSize outSize outChannels) 'WithoutBias inChannels outChannels 3 3 2 2 1 1 1 1
       , BatchNorm outChannels outSize outSize 90
       , Lift (LoadActivation Relu)
       , PaddedConvolution ('D3 outSize outSize outChannels)('D3 outSize outSize outChannels) 'WithoutBias outChannels outChannels 3 3 1 1 1 1 1 1
       , BatchNorm outChannels outSize outSize 90
       ]
...
type ResNet18BranchShrinkLeft inSize outSize inChannels outChannels
  = Network
      '[ PaddedConvolution ('D3 inSize inSize inChannels) ('D3 outSize outSize outChannels) 'WithoutBias inChannels outChannels 1 1 2 2 0 0 0 0
       , BatchNorm outChannels outSize outSize 90
       ]
      '[ 'D3 inSize inSize inChannels
       , 'D3 outSize outSize outChannels
...
type ResNetTest
  = Network
      '[ PaddedConvolution ('D3 224 224 3) ('D3 112 112 64 ) 'WithoutBias 3 64 7 7 2 2 3 3 3 3
       , Lift (LoadActivation Relu)
       ]
      '[ 'D3 224 224 3
       , 'D3 112 112 64
