...
type SuperResolution
  = Network
     '[ PaddedConvolution ('D3 224 224 1) ('D3 224 224 64) 'True 1 64 5 5 1 1 2 2 2 2 
      , Lift (LoadActivation Relu)
      , PaddedConvolution ('D3 224 224 64) ('D3 224 224 64) 'True 64 64 3 3 1 1 1 1 1 1 
      , Lift (LoadActivation Relu)
      , PaddedConvolution ('D3 224 224 64) ('D3 224 224 32) 'True 64 32 3 3 1 1 1 1 1 1 
      , Lift (LoadActivation Relu)
      , PaddedConvolution ('D3 224 224 32) ('D3 224 224 9) 'True 32 9 3 3 1 1 1 1 1 1 
