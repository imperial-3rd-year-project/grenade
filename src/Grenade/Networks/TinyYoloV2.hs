...
type TinyYoloV2 = Network
  '[ PaddedConvolution ('D3 416 416 3) ('D3 416 416 16) 'True 3 16 3 3 1 1 1 1 1 1
   , LeakyRelu
   , Lift (LoadActivation (Pooling 2 2 2 2))
   
   , PaddedConvolution ('D3 208 208 16) ('D3 208 208 32) 'True 16 32 3 3 1 1 1 1 1 1
   , LeakyRelu
   , Lift (LoadActivation (Pooling 2 2 2 2))

   , PaddedConvolution ('D3 104 104 32) ('D3 104 104 64) 'True 32 64 3 3 1 1 1 1 1 1
   , LeakyRelu
   , Lift (LoadActivation (Pooling 2 2 2 2))

   , PaddedConvolution ('D3 52 52 64) ('D3 52 52 128) 'True 64 128 3 3 1 1 1 1 1 1
   , LeakyRelu
   , Lift (LoadActivation (Pooling 2 2 2 2))

   , PaddedConvolution ('D3 26 26 128) ('D3 26 26 256) 'True 128 256 3 3 1 1 1 1 1 1
   , LeakyRelu
   , Lift (LoadActivation (Pooling 2 2 2 2))

   , PaddedConvolution ('D3 13 13 256) ('D3 13 13 512) 'True 256 512 3 3 1 1 1 1 1 1
   , LeakyRelu
   , PaddedPooling ('D3 13 13 512) ('D3 13 13 512) 2 2 1 1 0 0 1 1

   , PaddedConvolution ('D3 13 13 512) ('D3 13 13 1024) 'True 512 1024 3 3 1 1 1 1 1 1
   , LeakyRelu

   , PaddedConvolution ('D3 13 13 1024) ('D3 13 13 1024) 'True 1024 1024 3 3 1 1 1 1 1 1
   , LeakyRelu

   , BiasConvolution 'True 1024 125 1 1 1 1
   ]
  '[ 'D3 416 416 3                   -- Input
