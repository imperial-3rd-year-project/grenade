...
main = do
  ...
  defaultMain
    ...
    , bgroup
        "im2col_new"
        [ bench "im2col_new 3x4" $ whnf (im2col_new 2 2 1 1) ((3 >< 4) [1 ..])
        , bench "im2col_new 28x28" $ whnf (im2col_new 5 5 1 1) ((28 >< 28) [1 ..])
        , bench "im2col_new 100x100" $ whnf (im2col_new 10 10 1 1) ((100 >< 100) [1 ..])
        ]
    , bgroup
        "im2col_memcpy"
        [ bench "im2col_memcpy 3x4" $ whnf (im2col_memcpy 2 2 1 1) ((3 >< 4) [1 ..])
        , bench "im2col_memcpy 28x28" $ whnf (im2col_memcpy 5 5 1 1) ((28 >< 28) [1 ..])
        , bench "im2col_memcpy 100x100" $ whnf (im2col_memcpy 10 10 1 1) ((100 >< 100) [1 ..])
        ]
    , bgroup
        "col2im"
