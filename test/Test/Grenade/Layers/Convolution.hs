...
prop_conv_net_witness = property $
  blindForAll genOpaqueOpaqueConvolution >>= \(OpaqueConvolution ((Convolution _ _) :: Convolution channels filters kernelRows kernelCols strideRows strideCols)) -> success
